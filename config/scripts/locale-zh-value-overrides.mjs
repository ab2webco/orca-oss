...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Orca Lab IDE': 'Orca Lab IDE',
  'Orca Lab first': 'Orca Lab 优先',
  'Orca Lab Mobile': 'Orca Lab Mobile',
  'Orca Lab logo': 'Orca Lab 标志',
  'Enjoying Orca Lab?': '喜欢 Orca Lab 吗？',
  'Get to know Orca Lab': '了解 Orca Lab',
  'Expand Orca Lab': '展开 Orca Lab',
  'Support Orca Lab': '支持 Orca Lab',
  'Restarting Orca Lab…': '正在重启 Orca Lab…',
  'Orca Lab Attribution': 'Orca Lab 归因',
  'Show Orca Lab Mobile Button': '显示 Orca Lab Mobile 按钮',
  ...
  "Give agents direct access to Orca Lab's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Orca Lab 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
