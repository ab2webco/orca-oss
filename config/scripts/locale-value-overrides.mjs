...
export const LOCALE_VALUE_OVERRIDES = {
  es: {
    'Explore Orca Lab': 'Explorar Orca Lab',
  ...
  ko: {
    ...
    'Connect to Orca Lab': 'Orca Lab에 연결',
    'USB Devices': 'USB 장치',
  ...
  zh: {
    ...
    'Connect to Orca Lab': '连接到 Orca Lab',
    'USB Devices': 'USB 设备',
  ...
  ja: {
    ...
    'Try Again': '再試行',
    'Restart now': '今すぐ再起動',
    'Restart Orca Lab': 'Orca Lab を再起動',
    ...
    'Connect to Orca Lab': 'Orca Lab に接続',
    ...
    'Kill all': 'すべて強制終了',
    'kill all': 'すべて終了',
    'Collapse Orca Lab': 'Orca Lab を折りたたむ',
