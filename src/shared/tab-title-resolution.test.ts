...
describe('tab title resolution', () => {
  ...
  it('keeps OpenCode native and Orca Lab-generated title behavior intact', () => {
    const aiVaultTitle = {
      ...
      resolveTerminalTabTitle(
        {
          customTitle: null,
          aiVaultTitle,
          generatedTitle: 'Orca Lab generated',
    ...
    expect(
      resolveTerminalTabTitle(
        { customTitle: null, generatedTitle: 'Orca Lab generated', title: '⠋ albacore' },
        true
      )
    ).toBe('Orca Lab generated')
  })
