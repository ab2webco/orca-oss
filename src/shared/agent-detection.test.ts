...
describe('Pi-compatible title detection', () => {
  ...
  it.each([
    ...
    ['\u280b OMP', 'pi', '\u280b Pi'],
    [
      'lucky-echidna | \u283c π - Diagnose Orca Lab terminal title flicker - test',
      'omp',
      '\u280b OMP'
    ],
...
describe('Cursor agent title identity', () => {
  ...
  it('accepts every label Orca Lab synthesizes for Cursor', () => {
  ...
  ])('accepts the native or Orca Lab-synthesized Cursor title %j', (title) => {
  ...
  it.each([
    ...
    'Terminal Cursor and Orca Lab slows down',
    'cursor-agent',
    'cursor.exe',
    '~/cursor-rules',
    '',
