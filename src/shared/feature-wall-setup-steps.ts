...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Orca Lab's browser",
    subtitle: "Use Orca Lab's browser",
    description:
      'Browse your web app without leaving Orca Lab. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Orca Lab CLI',
    subtitle: 'Enable Orca Lab CLI',
    description:
      'Register the Orca Lab shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Orca Lab so you can start agent work without hunting for folders.'
  }
] as const
