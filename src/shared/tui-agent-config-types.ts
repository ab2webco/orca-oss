// Why its own module: `tui-agent-config.ts` carries the per-agent record, which both lineages
// grew past the 300-line ceiling; the shape it conforms to is a separate concern and moves cleanly.
