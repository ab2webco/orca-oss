...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'Orca Lab’s built-in prompt for this action, including the context Orca Lab knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the Orca Lab workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when Orca Lab has one available.',
