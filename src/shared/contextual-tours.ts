  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Bring your existing logins into Orca Lab to stay signed in immediately.',
    ...
    steps: [
      {
        ...
        body: 'Orca Lab isolates each task in its own worktree, branched off your base.',
