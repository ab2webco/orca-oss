...
import type { AgentTerminalTailApi } from './api/agent-terminal-tail-api'
import type { AgentSessionLogApi } from './api/agent-session-log-api'
...
export type PreloadApi = {
  ...
  mobile: MobileApi
  speech: SpeechApi
  agentTerminalTail: AgentTerminalTailApi
  agentSessionLog: AgentSessionLogApi
}

export type { ClaudeUsageApi, CodexUsageApi, OpenCodeUsageApi } from './api/agent-usage-api'
export type { AgentSessionLogApi } from './api/agent-session-log-api'
export type { AgentTerminalTailApi } from './api/agent-terminal-tail-api'
...
export type { PlaneApi } from './api/plane-api'
export type {
  PreflightApi,
