...
const PLANE_BASE_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'orca plane list [--filter everything|assigned|created|all|done (default: all = open items)] [--state <name>] [--priority none|low|medium|high|urgent] [--project <id>] [--limit <n>] [--workspace <id>|all] [--json]',
