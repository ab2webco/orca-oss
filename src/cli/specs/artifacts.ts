...
export const ARTIFACT_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'Share an HTML or Markdown file with your Orca Lab account',
  ...
  },
  {
    ...
    summary: 'Update a file previously shared from this Orca Lab profile',
  ...
  {
    path: ['artifacts', 'list'],
    summary: 'List artifacts owned by the signed-in Orca Lab account',
  ...
  },
  {
    ...
    destructive: true,
    summary: 'Delete an artifact owned by the signed-in Orca Lab account',
