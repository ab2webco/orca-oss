...
export const TERMINAL_CREATE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'orca terminal create [--worktree <selector>] [--title <name>] [--agent <id>] [--command <text>] [--task <task_id>] [--from <handle>] [--timeout-ms <n>] [--claude-account <email|id>] [--codex-account <email|id>] [--focus] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'worktree',
      'agent',
    ...
    examples: [
      ...
      'orca terminal create --worktree active --agent claude --task task_1 --json',
