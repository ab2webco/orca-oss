...
describe('orca cli browser waits and viewport flags', () => {
  ...
  it('does not tell users Orca Lab is down for a generic runtime timeout', async () => {
    ...
    expect(errorSpy).toHaveBeenCalledWith('Timed out waiting for the Orca Lab runtime to respond.')
  })
