...
describe('createEditorSlice activateMarkdownLink', () => {
  ...
  it('opens in-worktree file links in Orca Lab', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs inside the worktree in Orca Lab', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs outside the worktree in Orca Lab after authorizing them', async () => {
    const store = createEditorStore()
