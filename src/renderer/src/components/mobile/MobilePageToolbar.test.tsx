...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Orca Lab Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Orca Lab Mobile')
  })

  it('labels the restore action explicitly when Orca Lab Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
