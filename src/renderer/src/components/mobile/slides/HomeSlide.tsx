      ...
      <div className="mp-app-topbar">
        <div className="mp-app-brand">
          ...
          <span className="mp-app-brand-name">
            {translate('auto.components.mobile.slides.HomeSlide.5d94e8ddcc', 'Orca Lab')}
          </span>
        </div>
        <button
          type="button"
...
function OrcaLogo(): React.JSX.Element {
  return (
    <svg className="mp-orca-logo" viewBox="0 0 318 231" fill="currentColor" aria-hidden>
      <path d="M172.13 169.461C170.551 155.658 170.75 144.907 173.069 136.66C183.181 100.71 215.313 78.0025 254.887 81.5473C293.274 84.9858 316.318 114.667 317.94 152.873C319.666 193.536 283.979 230.62 240.418 230.62H99.4142C64.8791 230.62 38.1841 216.944 20.7949 193.031C6.97844 174.031 3.85102e-06 149.561 3.85102e-06 126.404C3.85102e-06 78.103 42.4907 32.2646 97.3951 32.2646C134.106 32.2646 163.477 49.223 184.294 81.7446C183.175 82.794 178.601 85.8176 172.13 94.324C167.815 99.9949 164.924 104.711 163.454 108.474C147.639 77.7013 126.304 63.7496 97.3951 63.7496C60.4352 63.7496 31.485 94.9806 31.485 126.404C31.485 143.259 36.6168 161.254 46.2591 174.514C57.74 190.303 74.9811 199.135 99.4142 199.135H240.418C266.095 199.135 287.448 176.946 286.483 154.209C285.481 130.598 265.551 114.511 250.431 113.346C225.553 111.118 206.4 125.01 202.803 146.151C201.684 152.725 201.684 157.427 203.83 169.27C183.958 169.405 173.391 169.469 172.13 169.461Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M217.005 6.03024L239.51 5.16922e-05L245.54 22.505C251.211 43.6682 238.652 65.4212 217.488 71.0919L194.983 77.1221L188.953 54.6171C183.283 33.454 195.842 11.7009 217.005 6.03024Z"
      />
    </svg>
  )
}
