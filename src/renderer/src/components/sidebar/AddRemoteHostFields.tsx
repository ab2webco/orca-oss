    ...
    >
      <div className="space-y-1.5">
        <Label htmlFor="add-server-name">
          {translate('auto.components.sidebar.AddRemoteHostDialog.serverName', 'Name in Orca Lab')}
        </Label>
        <Input
          id="add-server-name"
          value={name}
      ...
      <div className="space-y-1.5">
        ...
        <p id="add-server-pairing-code-help" className="text-xs text-muted-foreground">
          {translate(
            ...
            'Create this under Settings → Remote Orca Lab Servers → Share this host on the other computer.'
          )}
        </p>
        {inputError ? (
