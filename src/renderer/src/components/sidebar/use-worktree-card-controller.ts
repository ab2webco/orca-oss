...
export function useWorktreeCardController(props: ResolvedWorktreeCardProps) {
  ...
  const linked = useWorktreeCardLinkedDetails({
    ...
    linkedPlaneWorkItem: review.linkedPlaneWorkItem,
    planeWorkItemEntry: review.planeWorkItemEntry,
  ...
  const showPlaneWorkItem = foundation.cardProps.includes('plane-issue')
  ...
  useWorktreeCardLifecycleEffects({
    ...
    showPlaneWorkItem,
    linkedPlaneWorkItem: review.linkedPlaneWorkItem,
    planeWorkItemScopeId: review.planeWorkItemScopeId,
    fetchPlaneWorkItem: foundation.fetchPlaneWorkItem
  })
  ...
  const secondary = useWorktreeCardSecondaryDetails({
    ...
    planeWorkItem: linked.planeWorkItem,
    planeWorkItemDisplay: linked.planeWorkItemDisplay,
    prDisplay: review.prDisplay,
    linkedGitLabMR: review.linkedGitLabMR,
    linkedBitbucketPR: review.linkedBitbucketPR,
    linkedAzureDevOpsPR: review.linkedAzureDevOpsPR,
