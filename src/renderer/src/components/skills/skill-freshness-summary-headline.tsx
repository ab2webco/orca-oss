    ...
    return (
      <div className="flex items-center gap-2 text-xs text-muted-foreground">
        ...
        {translate(
          ...
          'Checking installed Orca Lab skills…'
        )}
      </div>
    )
  }
    ...
    return (
      <p className="text-xs text-muted-foreground">
        {translate(
          ...
          'No installed Orca Lab skills found.'
        )}
      </p>
    )
  }
    ...
    return (
      <div className="flex items-center gap-2 text-sm font-medium text-foreground">
        ...
        {translate(
          ...
          'All installed Orca Lab skills are up to date.'
        )}
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center gap-2 text-sm font-medium text-foreground">
        ...
        {translate(
          ...
          'Some installed Orca Lab skills were left out of the update.'
        )}
      </div>
    )
  }
