...
describe('handleOscLink', () => {
  ...
  it('opens local file URL links in Orca Lab with the platform modifier on desktop', async () => {
    setPlatform('Windows')
  ...
  it('opens #L file URL links in Orca Lab and preserves anchors', async () => {
