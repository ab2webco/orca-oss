...
describe('handleOscLink', () => {
  it('opens local .html file paths in Orca Lab browser tabs with the platform modifier', async () => {
  ...
  it('also opens local .htm paths in Orca Lab browser tabs with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('opens local file paths in Orca Lab and reveals default column 1 with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('preserves explicit column for Orca Lab opens from :line:column links', async () => {
    setPlatform('Macintosh')
  ...
  it('falls back to Orca Lab when shift+cmd/ctrl-click system default open fails', async () => {
    setPlatform('Macintosh')
  ...
  it('ignores stale async completion so latest local click wins for Orca Lab open and reveal', async () => {
    setPlatform('Macintosh')
