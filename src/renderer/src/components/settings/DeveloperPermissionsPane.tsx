  ...
  },
  {
    ...
    get description() {
      return translate(
        ...
        "macOS names Orca Lab when the agents it runs read other apps' data, because Orca Lab is the responsible process for terminal commands. Grant this to Orca Lab to reduce those prompts. Then quit and reopen Orca Lab."
      )
    },
    get actionLabel() {
      return translate(
  ...
  },
  {
    ...
    get description() {
      return translate(
        ...
        "Allows terminals and development tools to connect to services on your local network. macOS does not report this permission's current status to Orca Lab."
      )
    },
    get actionLabel() {
      return translate(
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-sm font-medium">
            ...
            {translate(
              ...
              "Terminal tools inherit Orca Lab's macOS privacy envelope."
            )}
          </div>
          <p className="text-xs text-muted-foreground">
            {translate(
              'auto.components.settings.DeveloperPermissionsPane.6326a4c5cc',
              'Use these controls when a CLI, local app, or automation tool needs macOS privacy access. Orca Lab does not ask at startup.'
            )}
          </p>
        </div>
