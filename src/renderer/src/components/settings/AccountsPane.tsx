      ...
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">
          {translate(
            ...
            'Stored locally. Orca Lab sends it only to platform.minimax.io for usage refreshes.'
          )}
        </p>
      </div>
      ...
      <section key="auto-switch-limits" id="accounts-auto-switch" className="space-y-3 scroll-mt-6">
        <SearchableSetting
          ...
          description={translate(
            ...
            'When a live Claude or Codex session hits an account limit, Orca Lab can switch to another managed account and resume the same session.'
          )}
              ...
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                {isRemoteAccountScope
                  ...
                  : translate(
                      ...
                      "No managed Claude accounts for {{value0}}. Orca Lab will use that environment's system default Claude login until you add one here.",
                      { value0: accountRuntimeSentenceLabel }
                    )}
              </div>
            ) : (
      ...
      <section key="codex-accounts" id="accounts-codex" className="space-y-4 scroll-mt-6">
          ...
          <p className="text-xs text-muted-foreground">
            {isRemoteAccountScope
              ...
              : translate(
                  ...
                  'Each account keeps its own local sign-in context in Orca Lab. Account auth stays on this device.'
                )}
          </p>
        </div>
        ...
        <SearchableSetting
          ...
          description={translate(
            ...
            'Manage which Codex account Orca Lab uses for live rate limit fetching.'
          )}
              ...
              <span>
                {codexConfigSyncWarning === 'managed-home-unavailable'
                  ? translate(
                      ...
                      'Orca Lab could not read this account\u2019s Codex files just now, so settings may not be syncing. This usually clears on its own \u2014 antivirus or a backup tool briefly locks them.'
                    )
              ...
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                {isRemoteAccountScope
                  ...
                  : translate(
                      ...
                      "No managed Codex accounts for {{value0}}. Orca Lab will use that environment's system default Codex login until you add one here.",
                      { value0: accountRuntimeSentenceLabel }
                    )}
              </div>
            ) : (
      ...
      <section key="gemini" id="accounts-gemini" className="space-y-4 scroll-mt-6">
        ...
        <SearchableSetting
          ...
          description={translate(
            ...
            'Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google. This uses credentials issued to the Gemini CLI app, not Orca Lab. May break if Google updates the CLI. Use at your own risk.'
          )}
          keywords={[
            'gemini',
            'cli',
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google for {{value0}}. This uses credentials issued to the Gemini CLI app, not Orca Lab. May break if Google updates the CLI. Use at your own risk.',
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {translate(
                ...
                'Removing this account permanently deletes its managed Codex home, including all Codex session history and MCP logins stored inside. This cannot be undone. If the account is currently active, Orca Lab falls back to the system default Codex login.'
              )}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
