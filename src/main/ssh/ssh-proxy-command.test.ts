...
describe('spawnProxyCommand', () => {
  ...
  describe('on Windows', () => {
    ...
    // Why: ssh.exe and cmd.exe are console-subsystem binaries; without windowsHide a visible
    // conhost flashes and steals keyboard focus on every connect/reconnect (#10488).
