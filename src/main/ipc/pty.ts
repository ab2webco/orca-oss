...
export function registerPtyHandlers(
  ...
  const bindProviderListeners = (): void => {
    ...
    localDataUnsub = boundProvider.onData((payload) => routeProviderData(payload, isLocalProvider))
  ...
  runtime?.setPtyController({
    spawn: async (args) => {
      ...
      // Why: the switch-in-progress check runs below, after the per-worktree pin
