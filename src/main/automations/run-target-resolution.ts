...
export function resolveAutomationRunTarget(
  ...
  if (
    ...
    return {
      ok: false,
      error:
        'Remote-server automation scheduling is not available from this Orca Lab client yet. Run this automation on the remote server or update Orca Lab when durable remote scheduling is available.'
    }
  }
