...
describe('DaemonPtyRouter history handoff', () => {
  ...
  beforeEach(async () => {
    ...
    currentServer = new DaemonServer({
      socketPath: getDaemonSocketPath(testDir, HISTORY_SEED_TRANSFER_PROTOCOL_VERSION),
  ...
  // Why 31, not upstream's 30: the merged daemon gates seed transfer on
  // HISTORY_SEED_TRANSFER_PROTOCOL_VERSION, because a lab-lineage v30 has none (ORCA-120).
