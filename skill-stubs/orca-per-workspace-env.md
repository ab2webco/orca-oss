...
Engage Orca Lab whenever you set up, review, debug, or validate a per-workspace environment
...
an `orca vm recipe doctor` failure. Orca Lab is a thin wrapper: you guide, detect, and scaffold;
