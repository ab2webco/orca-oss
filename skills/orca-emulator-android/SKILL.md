...
This file is a discovery stub, not the usage guide. The full, version-matched Orca Lab Android
...
Engage Orca Lab whenever you drive an adb-connected Android emulator or device from inside the
Orca Lab app: listing/booting AVDs, taps, swipes, typing, hardware buttons (including Back and
