...
their cached quota, or asks Orca Lab's runtime to swap the account of the terminal you are
...
change between Orca Lab releases, and this file deliberately no longer lists them.

## Never answer "which account am I on" from `active`

`active` is the account Orca Lab selects for *new* launches on the whole machine. It does not say
