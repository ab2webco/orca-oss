...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Orca Lab.',
      'Windows: Defender Firewall → Allow app — enable Orca Lab for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Orca Lab must be open on your desktop to accept connections.',
      'Try restarting Orca Lab — the companion server starts on launch.',
