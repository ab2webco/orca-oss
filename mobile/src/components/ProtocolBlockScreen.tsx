...
export function ProtocolBlockScreen({ verdict }: Props) {
  ...
  const title = isMobileTooOld ? 'Update Orca Lab Mobile' : 'Update Orca Lab on your computer'
  const body = isMobileTooOld
    ? `This desktop needs a newer Orca Lab Mobile app. Update Orca Lab Mobile from ${mobileUpdateTarget.storeName}, then try this host again.`
    : 'This paired desktop app is too old for your current Orca Lab Mobile app. Update Orca Lab on your computer, then try this host again.'
  const recoveryNote =
