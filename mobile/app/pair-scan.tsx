...
export default function PairScanScreen() {
  ...
  const handleBarCodeScanned = useCallback(
    ({ data }: { data: string }) => {
      ...
      if (!offer) {
        setStatus('error')
        setErrorMessage('Not a valid Orca Lab QR code')
      ...
      <View ref={setPairScanRootRef} style={[styles.container, containerPadding]}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.subtitle}>
            {canAskAgain
              ? 'Scan the QR code from Orca Lab on your desktop, or paste the pairing code instead.'
  ...
  return (
    <View ref={setPairScanRootRef} style={[styles.container, containerPadding]}>
      ...
      <View style={styles.steps}>
        <Step number={1} text="Open Orca Lab on your computer" />
